...
![](https://latex.codecogs.com/svg.latex?n_\text{c}=n_\text{c0}&space;\times&space;m)  

<img src="https://latex.codecogs.com/svg.latex?n_\text{c}=n_\text{c0} \times m"/>
...
<img src="https://latex.codecogs.com/svg.latex?\begin{align*}x&=y&space;\\&space;&=123\end{align*}"/>
...
![](https://latex.codecogs.com/svg.latex?\frac{p(C|V)}{p(C|\sim\\!\\!V)}=\frac{.27}{.66})  
...
![](https://latex.codecogs.com/svg.latex?p(C|\sim\\!\\!V)=\frac{n_\text{c0}}{n(1-p(V))})  
